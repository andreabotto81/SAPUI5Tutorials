		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Data Binding",
									"targetURL": "#comsapdatabinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapdatabinding-display": {
								"semanticObject": "comsapdatabinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.databinding",
									"url": sap.ui.require.toUrl("com/sap/databinding")
								}
							}
						}
					}
